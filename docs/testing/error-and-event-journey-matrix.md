...
| `NETWORK_ERROR` | Yes | Not covered | Call a stopped/unreachable local endpoint | Same retry path as other transient failures |
...
| `REQUEST_REJECTED` | No | Not covered | Return a representative non-authentication `4xx` | Same terminal path |
